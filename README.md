...
With this configuration you save almost $10/day ($300/month). Although, this configuration is not recommended for Production deployment, it's sufficient for dev, test and staging deployments.
